# Read Me First
This project provides an introduction to Spring Data Redis in a web application

* It is a "fork" of https://github.com/michaelcgood/spring-data-redis-example/
* The accompanying article by Michael Good explains how it works: https://dzone.com/articles/intro-to-redis-with-spring-boot
